...
const apStyles = StyleSheet.create({
    ...
    itemContent: { flex: 1 },
    time: { fontSize: 12 },
    emotion: { fontSize: 16, fontWeight: '500', textTransform: 'capitalize' },
...
export const EmotionTimeMachineScreen: React.FC<EmotionTimeMachineScreenProps> = ({ onGoBack }) => {
    ...
    const getAnalysisDetails = (analysis: any) => {
        ...
        return {
            valence: Math.round((analysis.valence || 0) * 100),
            arousal: Math.round((analysis.arousal || 0) * 100),
...
const styles = StyleSheet.create({
    ...
    timeJumpText: { fontSize: 14, fontWeight: '500' },
    ...
    evolutionTitle: { fontSize: 18, fontWeight: '600', flex: 1 },
    ...
    stateValue: { fontSize: 15, fontWeight: '600', lineHeight: 20 },
    ...
    aiText: { fontSize: 14, lineHeight: 22, fontStyle: 'italic' },
    ...
    insightLabel: { fontSize: 12, fontWeight: '600', color: '#ec4899', letterSpacing: 1 },
    insightText: { fontSize: 16, lineHeight: 24, fontStyle: 'italic' },
    ...
    deepenText: { color: '#fff', fontSize: 16, fontWeight: '600' },
});
