...
export const FoodLoadingScreen: React.FC<FoodLoadingScreenProps> = ({ onCancel }) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Animated.View style={[styles.loadingOrb, pulseAnimation, { 
          ...
          <FontAwesome name="cutlery" size={40} color={colors.textInverse} />
        </Animated.View>
        ...
        <View style={styles.loadingTextContainer}>
          <Text style={[styles.loadingTitle, { color: colors.textInverse }]}>{t('analysis.food.analyzingFood')}</Text>
          <Text style={[styles.loadingSubtitle, { color: 'rgba(255,255,255,0.85)' }]}>
            {t('analysis.food.processingSubtitle')}
          </Text>
...
const styles = StyleSheet.create({
  ...
  loadingRing: {
    ...
    // Colors will be set inline with colors.accent and colors.accentDark
    top: '40%',
  },
  loadingOrb: {
    position: 'absolute',
    ...
    height: 100,
    borderRadius: 50,
    // backgroundColor will be set inline with colors.accent
